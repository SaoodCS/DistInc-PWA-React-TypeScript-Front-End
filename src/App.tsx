...
import NotifClass, { INotifSettingFirestore } from './pages/main/settings/components/notifications/class/NotifClass';
...
export default function App(): JSX.Element {
   ...
   NotifClass.useQuery.getNotifSchedule({
      onSuccess: (data: INotifSettingFirestore) => {
         NotifClass.updateBadgeCount(0, data, setNotifScheduleInFirestore);
      },
   });
   return <AppRouter />;
}
